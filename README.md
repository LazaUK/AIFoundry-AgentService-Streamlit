...
In this repo, you will find the source code of a Streamlit-based demo kit that showcases Agent Service's various capabilities. The Web app can run locally on your computer and requires access to AI model deployed in Azure AI Foundry.
